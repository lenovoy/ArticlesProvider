...
public class ArticlesProvider extends ContentProvider {
	...
	public static final String LOG_TAG="com.vivo.providers.articles.ArticlesProvider";
	
	public static final String DB_NAME="Articles.db";
	public static final String DB_TABLE="ArticlesTable";
	...
	private Bundle getItemCount(){
		...
		SQLiteDatabase db=dbHelper.getReadableDatabase();
		Cursor cursor=db.rawQuery("select count(*) form "+DB_TABLE, null);
		int count=0;
